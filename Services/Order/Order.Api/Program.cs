...
using OrderService.Core.Handler;
using OrderService.Core.Services.Orders.Contracts;
using OrderService.Core.Services.Orders.Implementation;
using OrderService.Core.Services.OrderItems.Contracts;
using OrderService.Core.Services.OrderItems.Implementation;
...
try
{
    ...
    builder.Services.AddTransient<IOrderService, OrderService.Core.Services.Orders.Implementation.OrderService>();
    ...
    builder.Services.AddSwaggerService("Order Service API", "v1", "Automobile Workshop Production Service API", new OpenApiContact
    {
        Name = "AutoMobile"
    });
...
{
    Console.WriteLine("Order Service is shutting down");
}